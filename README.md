...
Published IEEE conference papers on AI systems, blockchain architectures, and software engineering. Active research in NLP — specifically large-context and multilingual LLM systems.

### Open Source

Contributor to production repositories with a focus on UX precision, correctness, and interaction bugs that affect real end users.

### Engineering

Built end-to-end deployed systems: AI-powered web applications, blockchain platforms, and developer tooling. Complete solutions, not demos.

### Hackathons

Won and placed in multiple hackathons with deployed, judged solutions.

---

### Current Interests

- LLM systems and multilingual NLP
- AI-powered developer tooling
- Scalable web architectures

---

Open to research collaborations and impactful open-source work. If you're building something where correctness and depth matter, let's talk.
...
[![Instagram](https://img.shields.io/badge/Instagram-%23E4405F.svg?logo=Instagram&logoColor=white)](https://instagram.com/Sahir00_)
[![Codepen](https://img.shields.io/badge/Codepen-000000?style=for-the-badge&logo=codepen&logoColor=white)](https://codepen.io/Sahir)
